...
const header = new Panel("[bold white on blue]Dashboard Header[/]", {
	box: "double",
	style: "blue",
});
const footer = new Panel("[dim]Status: Online | v1.0.0[/]", {
	box: "single",
	style: "dim",
});
...
layout.splitColumn(new Layout(header), bodyLayout, new Layout(footer));
