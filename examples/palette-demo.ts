import { Color, Console, Palette, Table, Theme } from "../src";
...
brandConsole.print(
	"This uses [primary]Brand Primary[/] and [secondary]Secondary[/].",
);
brandConsole.print(
	"Semantic mapping: [danger]Danger[/] (mapped to error color automatically).",
);
